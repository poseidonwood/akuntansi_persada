...
$.extend(Datepicker.prototype, {
	...
	/* Actions for selecting a new month/year. */
...
$.effects.animateClass = function( value, duration, easing, callback ) {
	...
	return this.queue( function() {
		...
		applyClassChange = function() {
			$.each( classAnimationActions, function(i, Actions) {
				if ( value[ Actions ] ) {
					animated[ Actions + "Class" ]( value[ Actions ] );
				}
			});
		};
		applyClassChange();
