...
var DragListener = Class.extend({
	...
	// Stops a given mouse event from doing it's native browser Actions. In our case, text selection.
							...
							button = $( // type="button" so that it doesn't submit a form
								...
								.click(function() {
									...
									if (!button.hasClass(tm + '-state-disabled')) {
										...
										// after the click Actions, if the button becomes the "active" tab, or disabled,
