		...
		<div class="box box-danger">
			<div class="box-body">
				<div class="col-md-12">
					...
					<div class="form-group">
						<?php echo form_label('Pengeluaran Apa: '); ?>
						<?php
						$data = array('class' => 'form-control input-lg', 'type' => 'text', 'name' => 'head_id', 'placeholder' => 'Pengeluaran Apa?', 'reqiured' => '');
					...
					<div class="form-group">
						<?php echo form_label('Detail Pengeluaran:'); ?>
						<?php
						$data = array('class' => 'form-control input-lg', 'type' => 'text', 'id' => 'description', 'name' => 'description', 'placeholder' => 'Detail pengeluaran ini untuk apa?', 'reqiured' => '');
						echo form_input($data);
						?>
					</div>
					<div class="form-group">
